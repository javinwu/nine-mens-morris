...
update msg model =
    case msg of
                    ...
                    Nothing ->
                        ...
                        case model.gameState.selectedPiece of
                            Just selectedPos ->
                                ...
                                -- (Reuse the ClickedPosition logic)
                                case getPieceAt selectedPos model.board of
                                    Just selectedColor ->
                                        ...
                                        if List.member pos adjacentPositions then
                                            -- Valid move to adjacent empty position
                                            let
        ...
        ClickedPosition pos ->
            -- PLACEMENT PHASE: Place a new piece on the board
            if model.gameState.phase == Placement then
                ...
                -- MOVEMENT PHASE: Move a selected piece to this position
                case model.gameState.selectedPiece of
                    Just selectedPos ->
