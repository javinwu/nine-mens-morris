...
var $author$project$View$Board$viewBoard = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			$elm$svg$Svg$Attributes$class('w-full h-full max-w-2xl mx-auto'),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('min-h-screen bg-gray-100 flex items-center justify-center p-8')
			]),
		_List_fromArray(
			[$author$project$View$Board$viewBoard]));
};
